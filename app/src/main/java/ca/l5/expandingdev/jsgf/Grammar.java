...
public class Grammar {
    ...
    private static List<Expansion> parseRuleReferences(List<Expansion> exp) throws RuntimeException {
    ...
    public static Expansion parseExpansionsFromString(String part) throws RuntimeException {
        String toParse = part;
