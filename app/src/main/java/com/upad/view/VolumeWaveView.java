...
public class VolumeWaveView extends View {
    ...
    private static final int HEIGHT = 100;//整个控件的高度

    private static final int HEIGHT1 = 15;//第一层曲线的高度
    private static final int HEIGHT2 = 13;//第二层曲线的高度
    private static final int HEIGHT3 = 18;//第三层曲线的高度
