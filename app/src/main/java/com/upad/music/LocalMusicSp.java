...
public class LocalMusicSp {
    ...
    private LocalMusicSp() {
        preferences = APP.getContext().getSharedPreferences("style", Context.MODE_PRIVATE);
        preferencesMusic = APP.getContext().getSharedPreferences("music", Context.MODE_PRIVATE);
        mGson = new Gson();
    }
