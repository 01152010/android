...
Java_com_serialport_core_SerialPort_open(JNIEnv *env, jclass thiz, jstring path, jint baudrate, jint stopBits, jint dataBits,
...
Java_com_serialport_core_SerialPort_close(JNIEnv *env, jobject thiz) {
