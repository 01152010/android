 ...
 *
 */
JNIEXPORT jlong JNICALL Java_com_webrtc_AEC_nativeCreateAecmInstance(JNIEnv *env, jclass thiz) {
 ...
 *
 */
JNIEXPORT jint JNICALL Java_com_webrtc_AEC_nativeFreeAecmInstance(JNIEnv *env, jclass thiz, jlong aecmHandler) {
 ...
 *
 */
JNIEXPORT jint JNICALL Java_com_webrtc_AEC_nativeInitializeAecmInstance(JNIEnv *env, jclass thiz, jlong aecmHandler, jint sampFreq) {
	void *aecmInst = (void *) aecmHandler;
	if (aecmInst == NULL)
		return -1;
 ...
 *
 */
JNIEXPORT jint JNICALL Java_com_webrtc_AEC_nativeBufferFarend(JNIEnv *env, jclass thiz, jlong aecmHandler, jshortArray farend, jint nrOfSamples) {
...
JNIEXPORT jshortArray JNICALL Java_com_webrtc_AEC_nativeAecmProcess(JNIEnv *env, jclass thiz, jlong aecmHandler, const jshortArray nearendNoisy, const jshortArray nearendClean, jshort nrOfSamples, jshort msInSndCardBuf) {
 ...
 *
 */
JNIEXPORT jint JNICALL Java_com_webrtc_AEC_nativeSetConfig(JNIEnv *env, jclass thiz, jlong aecmHandler, jobject aecmConfig) {
